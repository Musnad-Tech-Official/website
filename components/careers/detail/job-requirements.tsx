...
import type { JobRequirementsProps } from "./job-detail-types";
...
export function JobRequirements({
  ...
  return (
    <section aria-labelledby="job-requirements-heading" className={cn("text-start mt-10 sm:mt-12", className)}>
      <h2
